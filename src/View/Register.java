...
public class Register extends javax.swing.JPanel {
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_registerBtnActionPerformed
        int res = frame.registerAction(usernameFld.getText(), passwordFld.getText(), confpassFld.getText());
        if (res == -1) {
            jLabel2.setText("Passwords do not match");
        } else if (res == -2) {
            System.out.println("hello");
            jLabel2.setText("Password should be more than 8 characters have 1 uppercase letter"
